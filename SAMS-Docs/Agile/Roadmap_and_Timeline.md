...
| ~~17.5~~ | ~~**CLEANUP-SWEEP-1**~~ | ~~Pre-UC reliability + bug cleanup~~ | ~~6-10h~~ | ~~#79, #303, #305, #309, #310~~ ✅ COMPLETE (PR #326 merged May 4, 2026) + reconciliation follow-up closeout (#306, PR #330 merged May 6, 2026) |
...
**Current Focus**: **CLEANUP-SWEEP-1** and reconciliation follow-up are complete/merged (PR #326 + PR #330), including Email All timeout/polling hardening, cleared-transaction/credit-source fixes, reconciliation resume flow closeout, and reconciliation health card/date-contract hardening. Feature sprint queue now advances to **UC-LITE** (next strategic sprint for non-association/single-family support). **PROD-BACKUP-STABILIZATION** and **DEBT-1** remain queued unless promoted by risk. WhatsApp remains **paused**.
