 ...
 * 
 * Adjustments:
 * 1. Unit 101: Remove July charge (350→0), reduce August (300→60.27) due to June credit
 * 2. Unit 103: Add 400 pesos lavado (4 car washes not imported)
 * 3. Unit 106: Fix June (550→1029.47), July (550→310.27) - reading corrections
 * 
 * Also:
...
async function adjustUnit101(billData) {
  ...
  if (!unit) {
    console.log('  ⚠️ Unit 101 not found in Q1 bill');
    return null;
  }
...
async function adjustUnit106(billData) {
  ...
  if (!unit) {
    console.log('  ⚠️ Unit 106 not found in Q1 bill');
    return null;
  }
...
async function main() {
  try {
    ...
    if (!q1Bill) {
      console.log('❌ Q1 bill not found!');
      process.exit(1);
    }
    
    console.log('✅ Q1 bill loaded');
    ...
    console.log('  ✓ Unit 101: July removed (350→0), August reduced (300→60.27)');
    console.log('  - Unit 103: No changes (lavado discontinued)');
    console.log('  ✓ Unit 106: June/July fixed (550→1029.47, 550→310.27)');
    console.log('');
    console.log('Q2 Bill:');
    console.log('  ✓ Deleted (will be regenerated by SAMS)');
    console.log('');
