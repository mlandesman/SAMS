...
| SAMS engineering standards | `/Users/michael/Projects/SAMS/SAMS-Docs/SAMS Guides/Date_Handling_Guide.md`<br>`/Users/michael/Projects/SAMS/SAMS-Docs/SAMS Guides/INDEX_Accounting_Payments_Billing.md` | Date/time discipline (`new Date()` prohibition) and authoritative accounting/payments architecture guidance (SoA/UPC, reconciliation patterns) | When touching production code, especially date logic or shared finance domains |
