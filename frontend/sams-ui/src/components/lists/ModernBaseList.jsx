            ...
            <table className="modern-list-table">
              ...
              <tbody>
                {filteredItems.map((item, index) => {
                  // Use a more robust ID system - handle units with unitId, prefer item.id, fall back to index
                  const itemId = item.unitId || item.id || item.docId || item._id || item.name || index;
                  const selectedId = selectedItem?.unitId || selectedItem?.id || selectedItem?.docId || selectedItem?._id || selectedItem?.name;
                  const isSelected = selectedItem && selectedId !== undefined && selectedId === itemId;
