...
const PWANavigation = () => {
  ...
  // Admin navigation: Dashboard, Add Expense, Unit Report, HOA Dues
  const adminNavItems = [
    { label: 'Dashboard', icon: <DashboardIcon />, path: '/dashboard' },
    { label: 'Add Expense', icon: <ReceiptIcon />, path: '/add-expense' },
    { label: 'Unit Report', icon: <ReportIcon />, path: '/unit-report' },
    { label: 'HOA Dues', icon: <MoneyIcon />, path: '/hoa-dues' },
  ];

  // Unit Owner navigation: Dashboard, Unit Report
  const unitOwnerNavItems = [
    { label: 'Dashboard', icon: <DashboardIcon />, path: '/dashboard' },
    { label: 'Unit Report', icon: <ReportIcon />, path: '/unit-report' },
  ];

  // For users with both admin and unit owner roles, show admin nav
  ...
  const getNavItems = () => {
    ...
    return adminNavItems; // Default fallback
  };
