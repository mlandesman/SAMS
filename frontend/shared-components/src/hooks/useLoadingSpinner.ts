 ...
 * Shared hook for SAMS Desktop and Mobile applications
...
interface UseLoadingSpinnerReturn {
  isLoading: boolean;
  error: Error | null;
  startLoading: () => void;
  stopLoading: () => void;
...
const useLoadingSpinner = (options: UseLoadingSpinnerOptions = {}): UseLoadingSpinnerReturn => {
  const {
