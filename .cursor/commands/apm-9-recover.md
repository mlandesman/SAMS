...
The command argument - if provided - will be listed here: `(the text provided by the User after the command invocation, if any)`. If empty, then no argument was provided.
...
2. Re-read your initiation command and read every document it references - every guide, skill, and project artifact listed in its loading sequence:
   - Manager: `.cursor/commands/apm-2-initiate-manager.md`
   - Worker: `.cursor/commands/apm-3-initiate-worker.md`
