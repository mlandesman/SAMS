...
/**
 * Selective Purge Development Client Data
 * 
 * Safely removes specific client data collections from Development.
 * Allows selective purging of collections to preserve static data.
 * 
 * Usage:
 *   node purge-dev-client-selective.js --client MTC [options]
 * 
 * Options:
...
// Main purge function
async function main() {
  console.log('🗑️  Selective Development Purge Tool');
  console.log('====================================');
